...
while game_check:
    ...
    if len(popped_housie_numbers) >= 5:
        ...
        if players_zaldi5_check is False:
            players_zaldi5_check, zaldi5_player, intersection = zaldi5_check(
                popped_housie_numbers
            )
        ...
        if player_first_row_check is False:
            player_first_row_check, row1_player, row1 = row_check(
                1, popped_housie_numbers
            )
        ...
        if player_second_row_check is False:
            player_second_row_check, row2_player, row2 = row_check(
                2, popped_housie_numbers
            )
        ...
        if player_third_row_check is False:
            player_third_row_check, row3_player, row3 = row_check(
                3, popped_housie_numbers
            )
    ...
    if len(popped_housie_numbers) >= 15:
        player_full_housie_check, full_housie_player, card = full_housie_check(
            popped_housie_numbers
        )
